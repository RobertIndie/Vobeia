...
public class Chunk : MonoBehaviour {
    ...
    {
        get { return ChunksManager.instance.chunkWidth; }
    }
    public static int height
    {
        get { return ChunksManager.instance.chunkHeight; }
    }
    public byte[,,] map;
    ...
    {
        Random.InitState(ChunksManager.instance.seed);
    ...
    public virtual void CalculateMapFromScratch()
    {
        ...
        for (int x = 0; x < ChunksManager.instance.chunkWidth; x++)
        {
